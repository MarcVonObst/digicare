var youtubeExternalTest = angular.module('youtubeExternalTest', []);

youtubeExternalTest.factory('constants', function() {
  return {
...
youtubeExternalTest.factory('youtube', ['constants', function(constants) {
